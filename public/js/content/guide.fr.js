// Contenu en français — mirrors content/guide.en.js (canonical). Keep structure identical.
export const GUIDE_HUMAN = `# Vos 30 premières minutes
...
export const GUIDE_AGENT = `# Piloter IR Kit avec votre agent
...
export const CAPTABLE_101 = `# Cap table 101 — la version dix minutes
