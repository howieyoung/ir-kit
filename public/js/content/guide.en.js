// English guide content — the CANONICAL source. Translations live in guide.<locale>.js
// and MUST export the same four constants with the same structure (headings, tables,
// checkbox counts) so checklist state and docs generation stay consistent.
// docs/TUTORIAL.md is generated from THIS file (npm run build-tutorial).
