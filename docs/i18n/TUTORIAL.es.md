<!-- GENERATED from public/js/content/guide.es.js — edit there, then `npm run build-tutorial` -->
# Tutorial de IR Kit

[English](../TUTORIAL.md) · [繁體中文](TUTORIAL.zh-TW.md) · [日本語](TUTORIAL.ja.md) · [한국어](TUTORIAL.ko.md) · **Español** · [Français](TUTORIAL.fr.md)

La misma guía que vive en la app (**Empezar** en la barra lateral), en versión GitHub.

- [Operar IR Kit con tu agente](#operar-ir-kit-con-tu-agente) — la vía del agente
- [Tus primeros 30 minutos](#tus-primeros-30-minutos) — la vía manual
- [Cap table 101 — la versión de diez minutos](#cap-table-101--la-versión-de-diez-minutos) — si los SAFEs y la dilución son nuevos para ti
- [Glosario](#glosario)

---

# Operar IR Kit con tu agente
...
# Cap table 101 — la versión de diez minutos
